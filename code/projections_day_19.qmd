...
world_hd <- st_transform(world, hobo_dyer)
...
world$highlight <- dplyr::case_when(
  world$name %in% north_countries ~ "Global North",
  world$name %in% south_countries ~ "Global South",
  TRUE ~ "Other"
)
...
ggsave(
  filename = "../outputs/hobodyer_map.png",
  plot = p_hd,
...
ggsave(
  filename = "../outputs/mercator_map.png",
  plot = p_merc,
  width = 10, height = 6, units = "in",
  dpi = 600, bg = "#0B0B0B"
)
